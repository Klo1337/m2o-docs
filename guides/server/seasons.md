...
Weather templates belong to a season. The [Weather](/guides/catalogs/weather/) guide lists them in separate **Summer** and **Winter** tables, and a server should only select templates from the table matching its own season.
